...
!     Interactions: Kern_Frenkel Potential - H-boding (square-well with angular term)(attraction and repulsion) 
!     Simulation Technique: MC NPT
!     Last modified 25-02-2016
!     Code written by M. Ethayaraja modified to IPC by Remya Ann Mathews Kalapurakal
!-------------------------------------------------------------------------
       Program patchypom
!	 use IFPORT
       Implicit None
