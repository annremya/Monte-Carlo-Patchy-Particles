!     Control parameters      
      ...
      Integer nann
      Parameter (eqcycle=3d+8, procycle=1d+6)
      Parameter (nsample = 250000, nadj = 25000, nsamplep = 10 )
      Parameter (nann = 1, nxyze = 2000000, nxyzp = 2000)
!     Simulation parameters	
      Double precision  pres, rcut, T0, pi, alpha
      Parameter(pres = 0.01d0, rcut = 2.0d0, alpha = 1.0)
...
!     Potential parameters	
	...
	Parameter (epsiln1 = -2.0d0,epsiln2 = 2.0d0)
